...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  a relational database is a schema with tables inside it, of which columns are related to each other and to other tables. SQL is just one of many languages that allows for the creation of relational databases.

- [ ] Why do tables need a `primary key`?
  to ensure each relation/row is unique.

- [ ] What is the name given to a table column that references the primary key on another table.
  foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  a translation table, essentially a table that contains foreign keys from both tables
